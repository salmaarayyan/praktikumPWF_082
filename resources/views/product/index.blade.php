								...
								@forelse ($products as $product)
									...
									<tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition duration-100">
										...
										<td class="px-6 py-4 text-gray-600 dark:text-gray-300">
											<span
												class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $quantity > 10 ? 'bg-green-100 text-green-800 dark:bg-green-900/40 dark:text-green-300' : 'bg-red-100 text-red-700 dark:bg-red-900/40 dark:text-red-300' }}">
												{{ $product->quantity }}
											</span>
										</td>
